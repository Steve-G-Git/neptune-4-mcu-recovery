...
- Attempting direct MCU communication using STM32CubeProgrammer  
...
Once the MCU firmware was corrected, normal communication resumed and the printer returned to full functionality.
